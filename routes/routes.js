...
const {get_address,add_address,edit_address,update_address,remove_address} = require("../controllers/services/AddressController");
...
router.route("/address")
  ...
  .get(get_address);  /*** Get all Addresses ***/
router.route("/address/:id")
  .get(edit_address) /*** Get a Single Address ***/
  .put(update_address)  /*** Update Existing Address ***/
  .delete(remove_address);  /*** remove address ***/
